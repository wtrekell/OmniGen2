...
def downsample_raw(raw):
    ...
    The input raw should be a [4, H/2, W/2] tensor -- with respect to its mosaiced version [H,w]
    Output is a [4, H/4, W/4] tensor, preserving the RGGB pattern.
    """
    ...
    downsampled_image = F.avg_pool2d(raw.unsqueeze(0), kernel_size=2, stride=2, padding=0)
