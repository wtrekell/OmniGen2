...
def get_example():
    case = [
        [
            "In a sun-drenched studio, a sculptor chisels away at a block of marble.",
            1024,
            1024,
            50,
            None,
        ...
        [
            "A beautiful witch converses with wild animals in a rain forest filled with a magic ambiance and dreamy lighting, all rendered in hyperrealistic, fine-stenciled, animé style with aquarelle colors and ultra-fine lining.",
            1024,
            1024,
            50,
            None,
        ...
        [
            "Add a white mug with black polka - dots between the blue striped mug and the red floral mug.",
            1024,
            1024,
            50,
            "/share_2/luoxin/datasets/Distilled/flux_edit_pro/RefEdit/output_images/4392.png",
            None,
            None,
            NEGATIVE_PROMPT,
            5.0,
        ...
        [
            ...
            1024,
            50,
            "/share_2/luoxin/datasets/Distilled/flux_edit_pro/RefEdit/input_images/1555.png",
            None,
            None,
            NEGATIVE_PROMPT,
            5.0,
